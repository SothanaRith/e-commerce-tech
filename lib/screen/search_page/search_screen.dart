...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Colors.transparent, foregroundColor: Colors.transparent, surfaceTintColor: Colors.transparent, bottom: PreferredSize(preferredSize: Size(double.infinity, MediaQuery.sizeOf(context).width * 0.1), child: Padding(
